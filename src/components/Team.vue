<template>
  <div class="team">
      ...
      <v-container class="my-5">
        <v-row wrap>
            <v-col xs="12" sm="6" md="4" lg="3" v-for="person in team" v-bind:key="person.name">
                <v-card text class="text-center ma-3">
                    <v-responsive class="pt-4">
                        <v-avatar size="100">
                            <img v-bind:src="person.avatar" alt="imgnotloaded">
                        </v-avatar>
                    </v-responsive>
                    <v-card-text>
...
export default {
    data () {
        return {
            team: [
                { name: 'Domga', role: 'Web developer', avatar:'/avatar-1.png' },
